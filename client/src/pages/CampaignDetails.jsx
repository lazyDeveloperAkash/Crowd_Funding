...
import { CustomeButton, CountBox, Loader} from '../components'
    ...
    <div>
      ...
      <div className="w-full flex md:flex-row flex-col mt-10 gap-[30px]">
        <div className="flex-1 flex-col">
          ...
          <div className="relative w-full h-[5px] bg-[#3a3a43] mt-2">
            <div className="absolute h-full bg-[#4acd8d]"
              // calculate bar graph
              style={{ width: `${calculateBarGraph(state.target, state.ammountCollected)}%`, maxWidth: '100%' }}
            >
            </div>
          </div>
        </div>
        ...
        <div className="flex md:w-[150px] w-full flex-wrap justify-between gap-[30px]">
          ...
          <CountBox title={"Raised Amount"} value={state.ammountCollected} />
